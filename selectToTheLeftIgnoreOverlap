...
With this you can select all items that is on the Left side of the edit cursor, on selected tracks. All overlapping items are ignored. There's also a script for selecting items on the right side.
