...
With this you can select all items that is on the Right side of the edit cursor, on selected tracks. There's also a script for selecting items on the left side.
